...
export default function Solutions() {
  ...
  const industries = [
    ...
    { 
      name: 'Fintech', 
      icon: '💰', 
      description: 'Digital banking solutions, payment processing systems, and financial technology platforms for secure transactions.', 
      img: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZmludGVjaHxlbnwwfHwwfHx8MA%3D%3D'
    }
  ];
